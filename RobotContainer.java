...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    Abutton.whenPress(new Mamotaintput_command());

    Xbutton.whenPress(new MamotaOuttput_command());

    Bbutton.whenPress(new IntakeCollection_command());

    Ybutton.whenPress(new intakePiston_command());

    LBbutton.whenPress(new Climber_command());

    Rbbutton.whenPress(new IntakeMovment_command(-1))

    l1button.whenPress(new IntakeMovment_command(1))
  }
